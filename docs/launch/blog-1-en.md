...
to delegate Atoms at launch. This is because the empyreand tool used in the guide
...
Right after Cosmos-SDK v0.31.0 is released, a empyrean testnet will be released in
...
- Download software directly from official sources, and make sure that you’re
  always using the latest, most secure version of empyreand when you’re doing
  anything that involves your 12 words. The latest versions of Tendermint, the
  Cosmos-SDK, and empyreand will always be available from our official GitHub
