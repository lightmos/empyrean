...
本教程将详细说明如何在你的系统上安装`empyreand`和`empyreand`。安装后，你可以作为[全节点](./join-mainnet.md)或是[验证人节点](./validators/validator-setup.md)加入到主网。
...
接下来，安装最新版本的 empyrean。需要确认您 `git checkout 了正确的[发布版本](https://github.com/cosmos/cosmos-sdk/releases)。
...
等`empyreand`和`empyreand`可执行程序安装完之后，请检查:
