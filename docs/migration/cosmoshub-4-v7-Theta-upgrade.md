...
Then the Cosmovisor will create `$empyrean_HOME/cosmovisor/upgrades/v7-Theta/bin` and download empyrean v7.0.0 binary to this folder according to links in the `--info` field of the upgrade proposal 65.
